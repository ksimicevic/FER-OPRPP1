...
public class ArrayIndexedCollectionTest {
    ...
    public void testConstructorGiveArray() {
        ...
        ArrayIndexedCollection<Integer> testCollection = new ArrayIndexedCollection<>(startCollection, 2);
    ...
    public void testElementsGetter() {
        ...
        col2.add("Štefanija");
        col2.add("Karmela");
        Collection.ElementsGetter<String> getter1 = col1.createElementsGetter();
        Collection.ElementsGetter<String> getter2 = col1.createElementsGetter();
        Collection.ElementsGetter<String> getter3 = col2.createElementsGetter();
    ...
    public void testElementsGetterException() {
        assertThrows(NoSuchElementException.class, () -> {
            ...
            col.add("Ana");
            col.add("Jasna");
            Collection.ElementsGetter<String> getter1 = col.createElementsGetter();
            String result = "";
            result += getter1.getNextElement() + " ";
            result += getter1.getNextElement() + " ";
            result += getter1.getNextElement() + " ";
    ...
    public void hasNextElementsGetterTest() {
        ...
        col.add("Ana");
        col.add("Jasna");
        Collection.ElementsGetter<String> getter = col.createElementsGetter();
